...
def simulate_combo(strategy: str, severity: str, climate_name: str, bldg: BuildingSpec, base_cfg: HVACConfig, base_weather: pd.DataFrame, schedule_profile: Optional[Dict[str, float]] = None, random_state: int = 42):
